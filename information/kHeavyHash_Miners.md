---
layout: default
title: kHeavyHash Miners
nav_order: 3
network_difficulty: 0
zork_per_day_last_updated: "25JAN26"
---
...
## ![Bitmain](https://res.cloudinary.com/dluwgr5op/image/upload/c_limit,w_64/f_auto/q_auto/rew21mrlpnqjhtoxg5d9 "Bitmain") Bitmain

[Bitmain](https://www.bitmain.com/) is among the largest and longest-established ASIC manufacturers globally, best known for its **Antminer** brand and dominance in SHA‑256 (Bitcoin) mining. Like other kHeavyHash manufacturers, Bitmain produces dedicated hardware for the algorithm; unlike many of them, it is a vertically integrated giant with a broad product range across multiple algorithms and a large share of Bitcoin hashrate. Bitmain’s KS series (KS3 through KS7) targets the kHeavyHash segment with both older and newer models.
...
## ![IceRiver](https://res.cloudinary.com/dluwgr5op/image/upload/c_limit,w_64/f_auto/q_auto/tfmwi0j9nkqsrd3934ev "IceRiver") IceRiver

[IceRiver](https://www.iceriver.io/) is the mining hardware brand of [**BGIN Blockchain Limited**](https://www.bgin.com/) (NASDAQ: [BGIN](https://finance.yahoo.com/quote/BGIN)). BGIN is a digital-asset technology company that designs and manufactures cryptocurrency mining hardware and infrastructure. IceRiver is part of a publicly listed parent; unlike Bitmain, it focuses heavily on altcoin algorithms including kHeavyHash (KAS), Blake3 (ALPH), zkSNARK (ALEO), and others. IceRiver offers one of the broadest kHeavyHash lineups—from entry-level KS0/KS0 Pro up through KS7—plus hosting and integrated services. Official shop and product info: [iceriver.io](https://www.iceriver.io/).
...
## ![Goldshell](https://res.cloudinary.com/dluwgr5op/image/upload/c_limit,w_64/f_auto/q_auto/c1vgogd65otbzo5clxjj "Goldshell") Goldshell

[Goldshell](https://www.goldshell.com/) is the mining hardware brand of [**Intchains Group Limited**](https://intchains.com/) (NASDAQ: [ICG](https://finance.yahoo.com/quote/ICG)). Intchains is a publicly traded provider of altcoin mining products, Ethereum holdings, and Web3 applications. Goldshell targets altcoin algorithms rather than Bitcoin; it offers kHeavyHash models such as the KA BOX, KA-BOX Pro, and E-KA1M, alongside rigs for numerous other projects. Goldshell differentiates with products aimed at flexible, multi-algo use (e.g. swappable hash boards) and a focus on “blue‑ocean” altcoin segments. Official store: [goldshell.com](https://www.goldshell.com/).
...
## ![DragonBall](https://res.cloudinary.com/dluwgr5op/image/upload/c_limit,w_64/f_auto/q_auto/kzygev5pt8plybfwyg5d "DragonBall Miner") DragonBall

[DragonBall Miner](https://dragonballminer.com/en/) is an independent manufacturer of cryptocurrency mining equipment, with a product line including kHeavyHash models (KS6, KS6 Pro) and machines for RXD (SHA512256d) and ALPH (Blake3). Like Bitmain and IceRiver, DragonBall sells factory-built ASICs and offers hosting; unlike the large, publicly listed players, it operates as a focused hardware vendor without a public parent. The company stresses that Dragon Ball series miners are sold only via its [official site](https://dragonballminer.com/en/) and authorized agents—buyers should avoid unsanctioned third‑party channels.
...
## ![iBeLink](https://res.cloudinary.com/dluwgr5op/image/upload/c_limit,w_64/f_auto/q_auto/dsfwptvqxeodcvsph2zo "iBeLink") iBeLink

[iBeLink](https://en.ibelink.com.hk/) is the mining brand of **Fluxmind International Limited**. It produces ASICs for several algorithms, including kHeavyHash (BM-KS Max), Scrypt (e.g. BM-S3), and Nervos (BM-N3 series). Like DragonBall, iBeLink is an independent hardware vendor rather than a listed conglomerate; it emphasizes altcoin mining. The BM-KS Max is its sole kHeavyHash model listed here. Official site: [en.ibelink.com.hk](https://en.ibelink.com.hk/).
...
### Other
<img src="https://cdn.simpleicons.org/arm" width="64" alt="" decoding="async" /> <img src="https://cdn.simpleicons.org/riscv" width="64" alt="" decoding="async" /> <img src="https://cdn.simpleicons.org/raspberrypi" width="64" alt="" decoding="async" /> <img src="https://iconape.com/wp-content/files/bj/194137/svg/194137.svg" width="64" alt="" decoding="async" onerror="this.onerror=null;this.src='data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==';this.style.visibility='hidden';" />
...
Summary from [Raspberry Pi product documentation](https://www.raspberrypi.com/documentation/) and product pages. **PCIe** is a user- or carrier-exposed link (typical generation/lane count); **None** where no such port exists. MCU boards (**Pico**) use microcontroller cores, not application-class GPUs or PCIe.
...
Boards listed under Orange Pi’s [computer and microcontroller details index](http://www.orangepi.org/html/hardWare/computerAndMicrocontrollers/details/). **SoC** is the part number only (vendor follows from the part). **CPU** is the advertised core configuration. **PCIe** is generation × lane count where documented; **None** / **Unknown** if not applicable or unclear on the public listing.
